...
const Upload = () => {
  return (
    <section className="absolute flex flex-col items-center justify-center top-[124px] sm:top-[104px] md:top-[143px] w-full bg-secondary-foreground rounded-2xl px-3 md:px-24 max-w-[800px] h-[234px] sm:h-[352px] md:h-[452px] inset-0 mx-auto">
      ...
      <div className="w-full">
        <div className="mt-4 sm:mt-6 md:mt-12 flex gap-3 bg-white rounded-2xl items-center justify-center border-1 border-grey">
          ...
          <p className="flex items-center justify-center gap-1 py-20 sm:py-32 md:py-40 font-bold text-primary text-mobile-xl md:text-xl">
            ...
            <span className="underline underline-offset-2">upload a file</span>
          </p>
        </div>
