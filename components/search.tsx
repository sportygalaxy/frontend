  ...
  return (
    <div className="flex items-center border border-none rounded-2xl px-4 md:px-7 py-2 md:py-3 bg-secondary-foreground">
      <div className="md:block md:flex-2 mr-5 min-w-[120px]">
        <Select>
          <SelectTrigger className="text-mobile-2xl md:text-base font-bold flex flex-1 px-4 rounded-3xl">
      ...
      <input
        type="text"
        className="flex flex-2 w-full py-2 md:px-8 text-left bg-transparent placeholder-gray-500 border border-none rounded-md focus:outline-none focus:ring-0 focus:ring-transparent text-primary font-bold text-mobile-2xl md:text-xl"
