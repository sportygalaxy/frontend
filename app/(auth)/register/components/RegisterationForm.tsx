          ...
          <div className="flex flex-col items-center justify-start w-full">
            <div className="w-full mx-auto md:max-w-screen-sm space-y-11">
              ...
              <div className="relative flex flex-col items-center gap-5 xs:flex-row">
                ...
                <div className="flex flex-[3] justify-start w-full leading-none">
                  ...
                  >
                    ...
                    , (b) <span className="text-black">Terms of Use</span>, and
                    (c) <span className="text-black">Privacy Policy</span>. I
              ...
              <div className="w-full mt-8">
                <button
                  className="w-full text-white bg-black p-3 xs:p-5 rounded border-1 border-[#808080]"
                  type="submit"
                >
                  Agree and Register
                </button>
