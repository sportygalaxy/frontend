...
router.post("/send-reset-password-code", auth_controller_1.sendResetPasswordCode);
router.post("/validate-reset-password-code", auth_controller_1.validateResetPasswordCode);
router.post("/change-password", auth_controller_1.changePassword);
router.post("/change-password-reset", auth_controller_1.changePasswordViaReset);
